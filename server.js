...
const upload = multer({
  ...
  fileFilter: (_request, file, done) => {
    ...
    const isImage = file.fieldname === 'logo' && file.mimetype.startsWith('image/');
